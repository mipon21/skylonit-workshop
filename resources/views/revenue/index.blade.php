                ...
                return {
                    ...
                    get totals() {
                        ...
                        return {
                            ...
                            overhead: list.reduce(function (s, p) { return s + (p.paid_overhead ?? 0); }, 0),
                            overhead_total: list.reduce(function (s, p) { return s + p.overhead; }, 0),
                            sales: list.reduce(function (s, p) { return s + (p.paid_sales ?? 0); }, 0),
                            sales_total: list.reduce(function (s, p) { return s + p.sales; }, 0),
                            developer: list.reduce(function (s, p) { return s + (p.paid_developer ?? 0); }, 0),
                            developer_total: list.reduce(function (s, p) { return s + p.developer; }, 0),
                            profit: list.reduce(function (s, p) { return s + (p.paid_profit ?? 0); }, 0),
