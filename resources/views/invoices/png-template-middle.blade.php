{{-- Middle Payment invoice – uses invoice-middle.png. Add your image to public/images/invoice-middle.png --}}
@php
    $bgPath = public_path('images/invoice-middle.png');
...
<body>
    <div class="page">
        ...
        <div class="field" style="top: 61.7%; left: 28%; font-weight: bold; color: #cc0000;">{{ number_format($due, 0) }} BDT</div>
    </div>
</body>
</html>
