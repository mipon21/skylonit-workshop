            ...
            @if ($user instanceof \Illuminate\Contracts\Auth\MustVerifyEmail && ! $user->hasVerifiedEmail())
                <div>
                    <p class="text-sm mt-2 theme-text-secondary">
                        ...
                        <button form="send-verification" class="underline text-sm text-orange-400 hover:text-orange-300 rounded-md focus:outline-none focus:ring-2 focus:ring-orange-500">
