<x-app-layout>
    ...
    <div class="space-y-6" x-data="{
        ...
        <div class="project-tabs-wrap theme-card-bg-only theme-border border overflow-hidden shadow-sm" style="border-radius: 15px;">
            {{-- Parent tab row: Finance | Files & Links | Works | Activity --}}
            <div class="project-tabs-parent-row flex flex-wrap gap-2 justify-center items-center px-3 py-3 border-b theme-border theme-bg-tertiary min-h-[3.5rem]">
                @if(!($isDeveloper ?? false))
                <button type="button" @click="setParentTab('finance')" :class="activeParent() === 'finance' ? 'project-tab-active shadow-md' : 'theme-bg-secondary theme-border theme-text-primary border hover:bg-orange-500/15 hover:border-orange-500/40'" :style="activeParent() === 'finance' ? { backgroundColor: '#EF8121', color: '#ffffff', borderColor: '#EF8121' } : {}" class="px-6 py-2 rounded-[15px] text-sm font-semibold border-2 transition-all duration-200 inline-flex items-center gap-1.5 min-h-[2.5rem]">
                    <span>Finance</span>
                </button>
                @endif
                <button type="button" @click="setParentTab('files')" :class="activeParent() === 'files' ? 'project-tab-active shadow-md' : 'theme-bg-secondary theme-border theme-text-primary border hover:bg-orange-500/15 hover:border-orange-500/40'" :style="activeParent() === 'files' ? { backgroundColor: '#EF8121', color: '#ffffff', borderColor: '#EF8121' } : {}" class="px-6 py-2 rounded-[15px] text-sm font-semibold border-2 transition-all duration-200 inline-flex items-center gap-1.5 min-h-[2.5rem]">
                ...
                <button type="button" @click="setParentTab('activity')" :class="activeParent() === 'activity' ? 'project-tab-active shadow-md' : 'theme-bg-secondary theme-border theme-text-primary border hover:bg-orange-500/15 hover:border-orange-500/40'" :style="activeParent() === 'activity' ? { backgroundColor: '#EF8121', color: '#ffffff', borderColor: '#EF8121' } : {}" class="px-6 py-2 rounded-[15px] text-sm font-semibold border-2 transition-all duration-200 inline-flex items-center gap-1.5 min-h-[2.5rem]">
                    <span>Activity</span>
                    <span x-show="unviewedActivityCount > 0" x-transition class="min-w-[1.25rem] h-5 px-1.5 rounded-md bg-amber-400/90 text-white text-xs font-semibold tabular-nums flex items-center justify-center" x-text="unviewedActivityCount"></span>
                </button>
            </div>
            {{-- Sub-tab row: single line with horizontal scroll when needed --}}
            <div x-show="activeParent() === 'finance'" x-cloak class="project-tabs-sub-row flex flex-nowrap gap-2 justify-center md:justify-center overflow-x-auto px-3 py-2.5 border-b theme-border bg-black/5 dark:bg-white/5 min-h-[2.75rem] max-sm:py-3 max-sm:min-h-[3rem]">
                @if(!($isDeveloper ?? false))
                <button type="button" @click="setTab('payments')" :class="activeTab === 'payments' ? 'project-tab-active' : 'theme-bg-secondary theme-border theme-text-secondary border hover:bg-orange-500/10'" :style="activeTab === 'payments' ? { backgroundColor: '#EF8121', color: '#ffffff', borderColor: '#EF8121' } : {}" class="px-4 py-1.5 rounded-[15px] text-sm font-medium border-2 border-transparent transition-all duration-200 inline-flex items-center gap-1.5 min-h-[2rem] flex-shrink-0 max-sm:min-h-[2.5rem]">
                    <span>Payments</span>
                    <span class="min-w-[1.25rem] h-5 px-1.5 rounded-md theme-bg-tertiary theme-text-secondary text-xs font-semibold tabular-nums flex items-center justify-center">{{ $tabCountPayments }}</span>
                </button>
                <button type="button" @click="setTab('expenses')" :class="activeTab === 'expenses' ? 'project-tab-active' : 'theme-bg-secondary theme-border theme-text-secondary border hover:bg-orange-500/10'" :style="activeTab === 'expenses' ? { backgroundColor: '#EF8121', color: '#ffffff', borderColor: '#EF8121' } : {}" class="px-4 py-1.5 rounded-[15px] text-sm font-medium border-2 border-transparent transition-all duration-200 inline-flex items-center gap-1.5 min-h-[2rem] flex-shrink-0 max-sm:min-h-[2.5rem]">
                    <span>Expenses</span>
                    <span class="min-w-[1.25rem] h-5 px-1.5 rounded-md theme-bg-tertiary theme-text-secondary text-xs font-semibold tabular-nums flex items-center justify-center">{{ $tabCountExpenses }}</span>
                </button>
                <button type="button" @click="setTab('support')" :class="activeTab === 'support' ? 'project-tab-active' : 'theme-bg-secondary theme-border theme-text-secondary border hover:bg-orange-500/10'" :style="activeTab === 'support' ? { backgroundColor: '#EF8121', color: '#ffffff', borderColor: '#EF8121' } : {}" class="px-4 py-1.5 rounded-[15px] text-sm font-medium border-2 border-transparent transition-all duration-200 inline-flex items-center gap-1.5 min-h-[2rem] flex-shrink-0 max-sm:min-h-[2.5rem]">
                    <span>Support</span>
                    <span class="min-w-[1.25rem] h-5 px-1.5 rounded-md theme-bg-tertiary theme-text-secondary text-xs font-semibold tabular-nums flex items-center justify-center">{{ $tabCountSupport }}</span>
                </button>
                @if(!($isClient ?? false))
                <button type="button" @click="setTab('client')" :class="activeTab === 'client' ? 'project-tab-active' : 'theme-bg-secondary theme-border theme-text-secondary border hover:bg-orange-500/10'" :style="activeTab === 'client' ? { backgroundColor: '#EF8121', color: '#ffffff', borderColor: '#EF8121' } : {}" class="px-4 py-1.5 rounded-[15px] text-sm font-medium border-2 border-transparent transition-all duration-200 inline-flex items-center gap-1.5 min-h-[2rem] flex-shrink-0 max-sm:min-h-[2.5rem]">
                    <span>Client</span>
                    <span class="min-w-[1.25rem] h-5 px-1.5 rounded-md theme-bg-tertiary theme-text-secondary text-xs font-semibold tabular-nums flex items-center justify-center">1</span>
                </button>
                @endif
                @endif
            </div>
            <div x-show="activeParent() === 'files'" x-cloak class="project-tabs-sub-row flex flex-nowrap gap-2 justify-center md:justify-center overflow-x-auto px-3 py-2.5 border-b theme-border bg-black/5 dark:bg-white/5 min-h-[2.75rem] max-sm:py-3 max-sm:min-h-[3rem]">
                @if(!($isDeveloper ?? false))
                <button type="button" @click="setTab('contracts')" :class="activeTab === 'contracts' ? 'project-tab-active' : 'theme-bg-secondary theme-border theme-text-secondary border hover:bg-orange-500/10'" :style="activeTab === 'contracts' ? { backgroundColor: '#EF8121', color: '#ffffff', borderColor: '#EF8121' } : {}" class="px-4 py-1.5 rounded-[15px] text-sm font-medium border-2 border-transparent transition-all duration-200 inline-flex items-center gap-1.5 min-h-[2rem] flex-shrink-0 max-sm:min-h-[2.5rem]">
                    <span>Contracts</span>
                    <span class="min-w-[1.25rem] h-5 px-1.5 rounded-md theme-bg-tertiary theme-text-secondary text-xs font-semibold tabular-nums flex items-center justify-center">{{ $tabCountContracts }}</span>
                </button>
                @endif
                <button type="button" @click="setTab('documents')" :class="activeTab === 'documents' ? 'project-tab-active' : 'theme-bg-secondary theme-border theme-text-secondary border hover:bg-orange-500/10'" :style="activeTab === 'documents' ? { backgroundColor: '#EF8121', color: '#ffffff', borderColor: '#EF8121' } : {}" class="px-4 py-1.5 rounded-[15px] text-sm font-medium border-2 border-transparent transition-all duration-200 inline-flex items-center gap-1.5 min-h-[2rem] flex-shrink-0 max-sm:min-h-[2.5rem]">
                    <span>Documents</span>
                    <span class="min-w-[1.25rem] h-5 px-1.5 rounded-md theme-bg-tertiary theme-text-secondary text-xs font-semibold tabular-nums flex items-center justify-center">{{ $tabCountDocuments }}</span>
                </button>
                <button type="button" @click="setTab('notes')" :class="activeTab === 'notes' ? 'project-tab-active' : 'theme-bg-secondary theme-border theme-text-secondary border hover:bg-orange-500/10'" :style="activeTab === 'notes' ? { backgroundColor: '#EF8121', color: '#ffffff', borderColor: '#EF8121' } : {}" class="px-4 py-1.5 rounded-[15px] text-sm font-medium border-2 border-transparent transition-all duration-200 inline-flex items-center gap-1.5 min-h-[2rem] flex-shrink-0 max-sm:min-h-[2.5rem]">
                    <span>Notes</span>
                    <span class="min-w-[1.25rem] h-5 px-1.5 rounded-md theme-bg-tertiary theme-text-secondary text-xs font-semibold tabular-nums flex items-center justify-center">{{ $tabCountNotes }}</span>
                </button>
                <button type="button" @click="setTab('links')" :class="activeTab === 'links' ? 'project-tab-active' : 'theme-bg-secondary theme-border theme-text-secondary border hover:bg-orange-500/10'" :style="activeTab === 'links' ? { backgroundColor: '#EF8121', color: '#ffffff', borderColor: '#EF8121' } : {}" class="px-4 py-1.5 rounded-[15px] text-sm font-medium border-2 border-transparent transition-all duration-200 inline-flex items-center gap-1.5 min-h-[2rem] flex-shrink-0 max-sm:min-h-[2.5rem]">
                    <span>Links</span>
                    <span class="min-w-[1.25rem] h-5 px-1.5 rounded-md theme-bg-tertiary theme-text-secondary text-xs font-semibold tabular-nums flex items-center justify-center">{{ $tabCountLinks }}</span>
                </button>
            </div>
            <div x-show="activeParent() === 'works'" x-cloak class="project-tabs-sub-row flex flex-nowrap gap-2 justify-center md:justify-center overflow-x-auto px-3 py-2.5 border-b theme-border bg-black/5 dark:bg-white/5 min-h-[2.75rem] max-sm:py-3 max-sm:min-h-[3rem]">
                <button type="button" @click="setTab('tasks')" :class="activeTab === 'tasks' ? 'project-tab-active' : 'theme-bg-secondary theme-border theme-text-secondary border hover:bg-orange-500/10'" :style="activeTab === 'tasks' ? { backgroundColor: '#EF8121', color: '#ffffff', borderColor: '#EF8121' } : {}" class="px-4 py-1.5 rounded-[15px] text-sm font-medium border-2 border-transparent transition-all duration-200 inline-flex items-center gap-1.5 min-h-[2rem] flex-shrink-0 max-sm:min-h-[2.5rem]">
                    <span>Tasks</span>
                    <span class="min-w-[1.25rem] h-5 px-1.5 rounded-md theme-bg-tertiary theme-text-secondary text-xs font-semibold tabular-nums flex items-center justify-center">{{ $tabCountTasks }}</span>
                </button>
                <button type="button" @click="setTab('bugs')" :class="activeTab === 'bugs' ? 'project-tab-active' : 'theme-bg-secondary theme-border theme-text-secondary border hover:bg-orange-500/10'" :style="activeTab === 'bugs' ? { backgroundColor: '#EF8121', color: '#ffffff', borderColor: '#EF8121' } : {}" class="px-4 py-1.5 rounded-[15px] text-sm font-medium border-2 border-transparent transition-all duration-200 inline-flex items-center gap-1.5 min-h-[2rem] flex-shrink-0 max-sm:min-h-[2.5rem]">
                    <span>Bugs</span>
                    <span class="min-w-[1.25rem] h-5 px-1.5 rounded-md theme-bg-tertiary theme-text-secondary text-xs font-semibold tabular-nums flex items-center justify-center">{{ $tabCountBugs }}</span>
                </button>
            </div>
