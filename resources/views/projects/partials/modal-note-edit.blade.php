                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <select name="visibility" class="w-full rounded-xl bg-slate-900 border border-slate-600 text-white px-4 py-2.5 focus:ring-2 focus:ring-sky-500">
                            <option value="internal" {{ $note->visibility === 'internal' ? 'selected' : '' }}>Internal (admin only)</option>
                            <option value="client" {{ $note->visibility === 'client' ? 'selected' : '' }}>Client (future use)</option>
                        </select>
                    </div>
                </div>
