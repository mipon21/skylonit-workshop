                ...
                <div class="space-y-4">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <label class="js-visibility-toggle-label is-checked relative inline-flex items-center cursor-pointer gap-3 flex-shrink-0">
                            <input type="hidden" name="is_public" value="1" id="link-modal-is-public-hidden">
                            <input type="checkbox" value="1" checked class="sr-only expense-visibility-toggle" id="link-modal-is-public" data-hidden-id="link-modal-is-public-hidden" data-label-id="link-modal-visibility-label" aria-label="Public visibility">
                            ...
                            <span class="text-sm text-slate-300" id="link-modal-visibility-label">Public (anyone can see)</span>
                        </label>
                    </div>
                </div>
